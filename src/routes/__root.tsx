    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-lg gradient-brand px-5 py-2.5 text-sm font-semibold text-primary-foreground shadow-soft transition hover:opacity-90"
          >
            Volver al inicio
          </Link>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "FIXEO — Encuentra especialistas del hogar en Latinoamérica" },
      {
        name: "description",
        content:
          "Encuentra especialistas del hogar de confianza en técnicos y oficios. Solicita cotizaciones en minutos y contrata de forma segura.",
      },
